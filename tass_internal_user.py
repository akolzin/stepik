...
class TestMainPage1():
    ...
    def test_guest(self, browser, name, email, phone, adres, id, city, inn, kpp):
        ...
        # дата
        time.sleep(1)
        browser.find_element(By.XPATH, "/html/body/div[1]/div/div/div[3]/form/section[1]/section/div/div[6]/div/div/div/div/input").send_keys("11.09.2020")
        #input.send_keys("11.09.2020")
        input = browser.find_element(By.XPATH, "/html/body/div[1]/div/div/div[3]/form/section[1]/section/div/div[6]/div/div/div/div/input")
        input.click()
        input = browser.find_element_by_css_selector("#modal-root > div > div > div.Z36NgfhhAdPjQ8yA25RkK > div._2i6ikGcmypNEzZ5LByRFPh > div > div > div:nth-child(4) > div > div._1JOxArCwFF0kO-vBRkvC0j > div:nth-child(3) > div:nth-child(5)")
        input.click()
        ...
        browser.find_element_by_css_selector(
            "#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div:nth-child(7) > div > div > div > div > div > svg").click()
        time.sleep(0.5)
        browser.find_element_by_class_name("_2L3E4ziW_4O8Dr95BBr2YU").click()

        # менеджер
        input = browser.find_element_by_css_selector("#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div:nth-child(8) > div > div > div > div > div > p")
        input.click()
        ...
        input1 = browser.find_element_by_css_selector(
            "#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div:nth-child(8) > div > div > div > div > div > div._3oZXeuXkvti9Sua7CKx_8d > div > div:nth-child(1) > div:nth-child(1) > div")
        time.sleep(0.5)
        input1.click()

        # валюта
        input = browser.find_element_by_css_selector("#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div:nth-child(10) > div > div > div > div > div > p")
        input.click()
        input1 = browser.find_element_by_css_selector(
        ...
        # страна
        input = browser.find_element(By.XPATH, "//*[@id='root']/div/div/div[3]/form/section[1]/section/div/div[9]/div/div/div/div/div/p")
        input.click()
        input1 = browser.find_element(By.XPATH, "//*[@id='root']/div/div/div[3]/form/section[1]/section/div/div[9]/div/div/div/div/div/div[3]/div/div[1]/div[2]/div")
        time.sleep(1)
        input1.click()

        # источник
        input = browser.find_element_by_css_selector("#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div:nth-child(11) > div > div > div > div > div > p")
        input.click()
        time.sleep(0.5)
        input1 = browser.find_element_by_css_selector(
        ...
        input = browser.find_element_by_css_selector(
            "#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(4) > section > div._27thvWYvYYIFOWBO-Vt4uD._2zsxRxG1WzmnuxkzvdH11K > div > div > div > div > div > div > div.neLGgSRt5uRIuiNDvGsFB.bmHzo9bsOwH0VJrddnfGj")
        input.click()
        input1 = browser.find_element_by_css_selector(
            "#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(4) > section > div._27thvWYvYYIFOWBO-Vt4uD._2zsxRxG1WzmnuxkzvdH11K > div > div > div > div > div > div > div._3oZXeuXkvti9Sua7CKx_8d > div > div:nth-child(1) > div:nth-child(3) > div")
        time.sleep(1)
        input1.click()
    ...
    def test_guest(self, browser, name, email, phone, adres, id, city, inn, kpp):
        ...
        input = browser.find_element_by_css_selector("#root > div > div > div.MDTTD808z7GuhtYhNCiyx > form > section:nth-child(3) > section > div > div._2z02StXLta1l1pMy9RZjqn._2KqIDt_bTCe7sb8_y5pdt0._3vXHzL1qtcips0rxKwEhuQ > label > div")
        input.click()
